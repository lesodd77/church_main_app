          ...
          <div className="space-y-5 sm:space-y-4">
            ...
            >
             ...
             faithfulness to the
              ...
              <span class="relative inline-block before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-tertiaryOne">
                <span class="relative text-white">Ten Commandments of God</span>
              </span>
                ...
                <li key={about.name} className="sm:py-8">
                  <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
                    <div className="group aspect-w-3 aspect-h-2 flex items-center rounded-2xl bg-[#03050f27] shadow-lg sm:aspect-w-3 sm:aspect-h-4 sm:hover:bg-gray-300 sm:hover:ring-sky-400">
                      <a href="about">
                        <img
                          className="rounded-3xl object-cover px-4"
                          data-aos="zoom-in"
                          src={about.imageUrl}
                          alt=""
                        />
