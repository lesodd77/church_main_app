      ...
      <div className="flex flex-col justify-center flex-1 rounded-lg">
        <div className="lex flex-col overflow-hidden rounded-lg shadow-lg">
          ...
          <div>
            ...
            >
              <span className="relative inline-flex items-center px-3 py-0 font-bold border border-transparent rounded-l-full shadow-lg bg-sky-50 text-md shadow-cyan-900/50 dark:text-sky-500/80 hover:bg-sky-500/70 dark:hover:text-white">
                Update
              </span>
            </a>
          </div>
          ...
          <div className="flex flex-1 flex-col justify-between rounded-b-md bg-white p-6">
            <div className="flex-1">
              ...
              <a href={post.href} className="mt-2 block">
                <p className="text-xl font-serif font-semibold text-primary line-clamp-1">
                  {post.title}
                </p>
                <p className="font-serif  text-sm font-medium text-gray-700 truncate line-clamp-1">
                  {post.description}
                </p>
              </a>
            </div>
