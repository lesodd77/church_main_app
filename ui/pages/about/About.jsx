  ...
  <>
    ...
    <div className="bg-white bg-opacity-85 shadow-md dark:bg-slate-900">
      <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
        <h2 className=" text-3xl font-extrabold tracking-tight text-sky-400 dark:text-sky-400 sm:text-4xl">
          Who we are
        </h2>
        <div className="mt-7 space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          <div className="space-y-5 sm:space-y-4">
            <p className="font-serif text-gray-700 dark:text-slate-200">
              We are part of the International Missionary Society which is a
              Christian denomination that takes the Bible as its foundation of
              faith and practice and believes in Jesus as the Son of God and the
              Redeemer. His imminent second coming to earth, faithfulness to the
              <span className="relative inline-block before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-tertiaryOne">
                <span className="relative text-white dark:text-slate-100">
                  Ten Commandments of God
                </span>
              </span>
              &nbsp; and the principle of nonviolence are central to the
              movement's fundamental beliefs. Having its roots in the advent
              message preached in the nineteenth century, the organization
              considers the preaching of the gospel to all the world to be its
              primary mission.
            </p>
          </div>
                    ...
                    <div className="sm:col-span-2">
                      <div className="space-y-4">
                        <div className="space-y-1 text-lg font-medium leading-6 text-gray-700 dark:text-slate-700">
                          <h3 className=" dark:text-tertiaryOne">
                            {about.title}
                          </h3>
                        </div>
                        <div className="space-y-1 text-lg font-medium leading-6 text-gray-700 dark:text-slate-700">
                          <h3 className="text-sky-500 font-bold font-serif">
                            {about.name}
                          </h3>
                        </div>
